 ...
 */
final class Version20221023200312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE meal ADD owner_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9EF68E9C7E3C61F9');
        $this->addSql('ALTER TABLE meal DROP owner_id');
    }
}
